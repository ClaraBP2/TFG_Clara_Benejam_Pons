...
class FedProxStrategy(fl.server.strategy.FedAvg):
    ...
    def aggregate_fit(self,rnd: int,results: List[Tuple[ClientProxy, FitRes]],failures,):
        ...
        # ----------------------------------------------------
        # 1. Agregate weights using FedAvg
        # ----------------------------------------------------
        weights_results = [
        ...
        # ----------------------------------------------------
        # 2. Record metrics for this round
        # ----------------------------------------------------
        val_accs = []
        val_losses = []
        val_macro_f1s = []
        ...
        # ----------------------------------------------------
        # 3. Save best model if mean_val_macro_f1 is better than previous best
        # ----------------------------------------------------
        ...
        # ----------------------------------------------------
        # 4. Save round metrics to history
        # ----------------------------------------------------
        row = {
            "round": rnd,
